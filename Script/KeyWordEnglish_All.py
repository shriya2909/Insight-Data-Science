# -*- coding: utf-8 -*-
"""
Created on Thu Jun 25 20:03:04 2020
...
#Text Documents
txtdirectory ='C:/Users/Shriya/Desktop/Insight Data Science/Project/TL;DR/Evaluation/Data/PubMed/docsutf8/'
#Key for the docs
keytxtdirectory = 'C:/Users/Shriya/Desktop/Insight Data Science/Project/TL;DR/Evaluation/Data/PubMed/keys/'
count1 = 0 
count2 = 0 
...
for filename in os.listdir(txtdirectory):
    if filename.endswith(".txt"):
        count1 = count1 + 1
        txt = []
        txtfile = 'C:/Users/Shriya/Desktop/Insight Data Science/Project/TL;DR/Evaluation/Data/PubMed/docsutf8/' + filename
        print(txtfile)
        ...
        keyfile = 'C:/Users/Shriya/Desktop/Insight Data Science/Project/TL;DR/Evaluation/Data/PubMed/keys/' + filename.replace(".txt", ".key")  
        count2 = count2 + 1
        print(keyfile)
        key = []
        stripkey = []
